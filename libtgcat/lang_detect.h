...
{
    auto unicode_threshold = settings["unicode_threshold"];
    auto fasttext_threshold = settings["fasttext_threshold"];
    auto en_compare_threshold = settings["en_compare_threshold"];
    auto en_compare_ratio = settings["en_compare_ratio"];

    auto words = tokenize(text);
    auto char_dict = get_char_dict(words);
    auto alphabet_dict = get_alphabet_dict(char_dict, unicode_threshold);
